            ...
            href={
              signedIn
                ...
                : {
                    ...
                    query: {
                      redirect: `${razorPayLinks[0]}`,
                    },
                  }
            }
          >
            <div className="cursor-pointer rounded-[96px] font-bold text-white bg-[#6766FF] text-center py-4 text-xl">
            ...
            href={
              signedIn
                ...
                : {
                    pathname: "/auth/sign-in",
                    query: {
                      redirect: `${razorPayLinks[1]}`,
                    },
                  }
            }
          >
            <div className="cursor-pointer flex font-bold items-center justify-center gap-4 rounded-[96px] text-white bg-[#6766FF] py-4 text-xl">
      ...
      <div className="hidden lg:flex flex-col gap-8">
        ...
        >
          ...
          <div className="flex gap-7 flex-col">
            ...
            >
              <div className="cursor-pointer rounded-[96px] font-bold text-white bg-[#6766FF] text-center py-4 text-lg">
                Get Started
              </div>
            </Link>
          </div>
        ...
        <div>
          ...
          >
            ...
            >
              <div className="cursor-pointer rounded-[96px] font-bold text-white bg-[#6766FF] text-center mt-4 py-4 text-lg">
                Get Started
              </div>
            </Link>
          </div>
    ...
    <div className="relative">
      ...
      >
        ...
        <div className="flex gap-7 flex-col">
          ...
          >
            <div className="cursor-pointer rounded-[96px] font-bold text-[#6766FF] bg-white text-center py-4 text-xl">
              Get Started for 1 Month
            </div>
          </Link>
          <Link
          ...
          >
            <div className="cursor-pointer flex items-center justify-center gap-4 rounded-[96px] text-[#6766FF] bg-[white] py-4 text-xl font-bold">
              <span>For 3 Months</span>
              <span className="flex">
                <div className="relative mr-2">
                  <svg
      ...
      <div className="hidden lg:flex  flex-col gap-8">
        ...
        >
          ...
          <div className="flex gap-7 flex-col">
            ...
            >
              <div className="cursor-pointer rounded-[96px] font-bold text-[#4A3AFF] bg-[white] text-center py-4 text-lg">
                Get Started
              </div>
            </Link>
          </div>
        ...
        <div>
          ...
          >
            ...
            >
              <div className="cursor-pointer rounded-[96px] font-bold text-[#6766FF] bg-white text-center mt-4 py-4 text-lg">
                Get Started
              </div>
            </Link>
          </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center overflow-x-hidden">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <PricingCard {...data[0]} signedIn={signedIn} />
        <PopularPricingCard {...data[1]} signedIn={signedIn} />
      </div>
    </div>
  );
}
